...
namespace EchoConsole
{
    ...
    {
        /// <summary>
        /// Indicates the console should throw an exception on start
        /// </summary>
        public const string EXCEPTION_KEY = "throwException";

        /// <summary>
        /// Indicates the console should exit on start
        /// </summary>
        ...
        public const string FLOOD_OUTPUT = "ping";
        ...
        public static void Main(string[] args)
        {
            if (args.Length > 0)
            {
                switch (args[0])
                {
                    ...
                    case FLOOD_KEY:
                        while (true)
                            Console.WriteLine(FLOOD_OUTPUT);
                    default:
                        while (true)
                        {
